...
<div class="carousel slide d-none d-md-block" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <img src="{{ asset("img/frontend/background/rlaVme5.png") }}" class="d-block w-100" alt="你是南一中嗎">
            <div class="carousel-caption text-left mb-5 pb-5 text-dark">
                <h1 class="text-black-stroke display-3">靠北南一中</h1>
                <p class="lead">發源自臉書──全台最大南一中廢文社群</p>
...
<div class="carousel slide d-md-none" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <img src="{{ asset("img/frontend/background/vznInUz.png") }}" class="d-block w-100" alt="你是南一中嗎">
            <div class="carousel-caption text-left mb-5 text-dark">
                <h3 class="text-black-stroke">靠北南一中</h3>
